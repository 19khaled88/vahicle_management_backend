...
router.get('/:id', invenToryRequest_controller_1.inventoryRequestControllers.singleInventoryRequestController);
router.delete('/:id', invenToryRequest_controller_1.inventoryRequestControllers.deleteInventoryRequestController);
router.patch('/:id', invenToryRequest_controller_1.inventoryRequestControllers.updateInventoryRequestController);
